...
## ADR-006: 卸先を先に確定して作業コンテキストとして保持する

決定: 商品を選ぶ前に卸先と業務日付を確定し、カウント作業中は同じコンテキストを維持する。

理由:

- 現場の記録単位である卸先ごとに作業をまとめられる
- 同じ卸先へ複数の商品を連続登録しやすい
- 保存レコードへ卸先IDと表示名のスナップショットを一貫して残せる
- URLから作業コンテキストを復元し、不完全な状態での入力を防げる
